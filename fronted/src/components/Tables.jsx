          ...
          <tbody>
            ...
            <tr>
              <td className="nextPrev">
                ...
                {nextData.length > 0 ? <button onClick={() => getNextData()}><svg xmlns="http://www.w3.org/2000/svg" width="3vw" height="3vw" fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
