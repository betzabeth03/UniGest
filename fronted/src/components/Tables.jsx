                ...
                <td>
                  {(role === "Director") || (role === "Profesor" && props.uri === "actividades") ?
                    <div className="buttonsTable">
                      <button className="tableButton"><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                      ...
                      <button onClick={(e) => deleteElement(e)} name={item.id} className="tableButton"><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" fill="red" class="bi bi-trash3-fill" viewBox="0 0 16 16">
