      ...
      <div className='buildLogin'>
          ...
          <form onSubmit={(e)=>handleSubmit(e)} className='loginForm'>
            <div className='logosIn'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="2vw" height="2vw" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
            ...
            <div className='logosIn'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="2vw" height="2vw" fill="currentColor" class="bi bi-lock-fill" viewBox="0 0 16 16">
