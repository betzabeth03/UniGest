...
export default function FormRegister() {
  ...
  return (
    <form onSubmit={(e)=>handleSubmit(e)} className='form'>
        ...
        <input type="text" className='input' placeholder='Usuario' name="user"/>
        ...
        <input type="password" className='input' placeholder='Clave de registro' name="registerpass" required/>
        {
