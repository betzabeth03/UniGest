...
export default function Menu() {
    ...
    return (
        <div className={`menu ${displayMenu}`}>
            <div className='linksDirector'>
                <div className='btOpen'>
                    <button className='btMenu' onClick={()=>openMenu()}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="2.5vw" height="2.5vw" fillRule="currentColor" className="bi bi-list" viewBox="0 0 16 16">
                ...
                <div className='buttons'>
                   <a href="/profesores" className='linksMenu'>
                ...
                <div className='buttons'>
                    <a href="/materias" className='linksMenu'>
                ...
                <div className='buttons'>
                    <a href="/secciones" className='linksMenu'>
                ...
                <div className='buttons'>
                   <a href="/actividades" className='linksMenu'>
            ...
            <div onClick={()=>logout()} className='buttons'>
